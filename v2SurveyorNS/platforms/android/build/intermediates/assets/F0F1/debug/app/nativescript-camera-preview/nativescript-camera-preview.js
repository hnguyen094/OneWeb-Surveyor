...
const mSurfaceTextureListener = new android.view.TextureView.SurfaceTextureListener({
    ...
    // the callback runs the animations of the objects in the app
...
/**
Function: closes the camera on exit or pause
*/
...
/**
Function: Starts the BackgroundThread. Still here because of the original project
UNUSED
*/
...
/**
Function: Stops the BackgroundThread. Still here because of the original project
UNUSED
*/
...
/**
Function: Sets up the camera output settings.
*/

...
@com.tns.JavaScriptImplementation(javaScriptFile = "./nativescript-camera-preview/activity.js")
public class MainActivity extends android.app.Activity implements com.tns.NativeScriptHashCodeProvider {
	public MainActivity(){
		super();
